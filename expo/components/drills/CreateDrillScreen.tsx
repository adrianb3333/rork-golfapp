...
interface CreateDrillScreenProps {
  onBack: () => void;
  onSave: (drill: CustomDrill) => void;
}
...
export default function CreateDrillScreen({ onBack, onSave }: CreateDrillScreenProps) {
    ...
    >
      ...
      >
        <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
          ...
          <Text style={styles.headerTitle}>Create Drill</Text>
            ...
            >
              <View style={styles.previewInner}>
                ...
                <Text style={styles.previewText}>
                  {selectedRounds} rounds × {selectedTargets} targets = {totalShots} total shots
                </Text>
              </View>
            </LinearGradient>
          </View>
