          ...
          <View style={styles.modalBackground}>
            <View style={styles.modalContainer}>
                <ScrollView contentContainerStyle={{ padding: 24 }}>
                    <Text style={[styles.modalTitle, { color: currentColor }]}>Power Line Drill</Text>
                    <Text style={styles.modalText}>Improve distance control and consistency with your {header}.</Text>
...
export default function PowerLineDrill({ onBack, drillName = "Power Line" }: { onBack: () => void, drillName?: string }) {
