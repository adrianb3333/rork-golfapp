          ...
          <View style={styles.modalBackground}>
            <View style={styles.modalContainer}>
                <ScrollView contentContainerStyle={{ padding: 24 }}>
                    <Text style={[styles.modalTitle, { color: currentColor }]}>Cirkel Drill</Text>
                    <Text style={styles.modalText}>Complete 3 rounds of 10 shots to improve precision. This drill tracks your consistency over multiple sets.</Text>
  ...
  return (
    <SafeAreaView style={styles.fullScreenContainer}>
      <View style={styles.innerContent}>
        ...
        <Text style={{ color: COLORS.textDim, marginBottom: 32, fontSize: 16 }}>Great consistency today.</Text>
        ...
        <View style={styles.avgCard}>
          ...
          <div style={styles.resultsAvgRow}>
            {labels.map((label, i) => (
              <View key={i} style={{ alignItems: 'center' }}>
                <Text style={styles.miniLabel}>R{i+1}</Text> 
...
export default function Cirkel({ onBack, drillName = "The Cirkel" }: { onBack: () => void, drillName?: string }) {
  ...
  const headers = ['Round 1', 'Round 2', 'Round 3'];
      ...
      <View style={styles.startOverlay}>
        <Pressable onPress={() => setIsStarted(true)} style={styles.startButtonContainer}>
          <View style={[styles.startDrillBorder, { borderColor: COLORS.blue }]}>
            <Text style={[styles.startDrillText, { color: COLORS.blue }]}>Start Cirkel</Text>
          </View>
