          ...
          <View style={styles.modalBackground}>
            <View style={styles.modalContainer}>
                <ScrollView contentContainerStyle={{ padding: 24 }}>
                    <Text style={[styles.modalTitle, { color: currentColor }]}>Swing Pause</Text>
                    <Text style={styles.modalText}>Improve your tempo and control with the {header}. Focus on the pause at the transition.</Text>
...
const ResultsCard: React.FC<{ scores: number[]; avgs: number[]; onBack: () => void; onRestart: () => void; labels: string[] }> = ({ scores, avgs, onBack, onRestart, labels }) => {
  return (
    <SafeAreaView style={styles.fullScreenContainer}>
      <View style={styles.innerContent}>
        <Pressable onPress={onBack} style={styles.internalBackButton}>
        ...
        <Text style={{ color: COLORS.textDim, marginBottom: 32, fontSize: 16 }}>Swing Pause complete.</Text>
...
export default function SwingPause({ onBack, drillName = "Swing Pause" }: { onBack: () => void, drillName?: string }) {
      ...
      <View style={styles.startOverlay}>
        <Pressable onPress={() => setIsStarted(true)} style={styles.startButtonContainer}>
          <View style={[styles.startDrillBorder, { borderColor: COLORS.blue }]}>
            <Text style={[styles.startDrillText, { color: COLORS.blue }]}>Start Swing Pause</Text>
          </View>
