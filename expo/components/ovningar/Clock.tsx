          ...
          <View style={styles.modalBackground}>
            <View style={styles.modalContainer}>
                <ScrollView contentContainerStyle={{ padding: 24 }}>
                    <Text style={[styles.modalTitle, { color: currentColor }]}>Clock Drill</Text>
...
export default function ClockDrill({ onBack, drillName = "The Clock" }: { onBack: () => void, drillName?: string }) {
      ...
      {step < 3 ? (
        <LiquidGlassCard 
          ...
          onNext={(score, made) => {
            ...
            saveToSupabase(made); // Send result to Supabase
